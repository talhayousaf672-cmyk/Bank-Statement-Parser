...
from bank_parser.parsers.allied_bank import AlliedBankParser
...
def register_builtin_parsers(registry: ParserRegistry | None = None) -> ParserRegistry:
    ...
    target_registry.register(MCBParser)
    target_registry.register(AlliedBankParser)
    target_registry.register(BankAlfalahParser)
