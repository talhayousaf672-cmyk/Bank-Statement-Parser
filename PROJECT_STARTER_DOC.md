...
| Umer | Dev B - Validation & Data Lead | Reconciliation, confidence scoring, QA harness, review queue schemas, Supabase/Postgres models |
| Talha | Dev C - App & Localization Lead | Excel export, translated headers, desktop UI, web UI, packaging/deployment, AI enrichment integration |
...
| 2. Validation | 3-6 | Umer | Reconciliation engine, confidence scoring, test harness |
| 3. Export & Localization | 5-7 | Talha | Excel writer, translated headers, RTL sheet handling |
| 4. Multi-Bank Expansion | 6-12 | Mohsin + Talha | Additional bank parser classes |
| 4.5. AI Assist | 9-13 | Mohsin + Talha | Onboarding draft, fallback extraction, enrichment |
| 5A. Desktop | 8-11 | Talha | PySide6 app, SQLite review queue, packaged exe |
| 5B. Web | 8-13 | Talha + Umer | FastAPI, Supabase, React UI, async jobs |
| 6. Hardening | 10-14 | Umer + All | Accuracy pass, edge cases, load/security checks |
...
| Implement reconciliation validator | Umer | P0 |
| Implement Excel header map and writer skeleton | Talha | P0 |
| Add example parser and test fixture | Mohsin | P1 |
| Add CLI smoke command | Mohsin + Umer | P1 |
| Add desktop/web placeholder adapters | Talha | P1 |
| Draft security checklist | Umer + Talha | P2 |
